...
void rechercherLivre() {
    ...
    printf("Entrez l'ID du livre � rechercher : ");
    scanf("%d", &id);

    while (fread(&l, sizeof(Livre), 1, f)) {
        if (l.id == id) {
            printf("Livre trouv� : %s (Auteur ID: %d)\n", l.titre, l.idAuteur);
            trouve = 1;
            break;
        }
    }
...
void modifierLivre() {
    ...
    printf("ID du livre � modifier : "); scanf("%d", &id);
...
l.nombreDispo = l.nombreTotal;
    ...
    if (trouve) printf("Livre modifi� avec succ�s.\n");
}
...
void supprimerLivre() {
    ...
    printf("ID du livre � supprimer : "); scanf("%d", &id);
    ...
    if (trouve) printf("Livre supprim� avec succ�s.\n");
